...
func Run2(ic map[int64]int64, inputs []int64, outputs []int64) {
	var ptr int64 = 0
	...
	for {
		...
		case 4: // output
			outputs = append(outputs, getInputValue(ic, ptr+1, modes[0], relativeBase))
...
func RunSimple(ic map[int64]int64, inputs []int64, inChan chan int64, outChan chan int64, manualMode bool) []int64 {
	go func() {
		defer close(outChan)
